const jsonUrl = 'https://raw.githubusercontent.com/collinsleni/.json/refs/heads/main/leniindex.json';
...
fetch(jsonUrl)
    ...
    function visualizeData(data) {
        ...
        const allStudents = data.admissionData.pages.flatMap(page => page.student);
    ...
    function visualizeDatapopularity(data) {
        ...
        const course_name = Object.keys(popularityCounts);
